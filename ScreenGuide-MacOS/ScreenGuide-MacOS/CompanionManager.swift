...
final class CompanionManager: ObservableObject {
    ...
    you're screenguide, a friendly always-on companion that lives in the user's menu bar. the user just spoke to you via push-to-talk and you can see their screen(s). your reply will be spoken aloud via text-to-speech, so write the way you'd actually talk. this is an ongoing conversation — you remember everything they've said before.
    ...
    private func speakCreditsErrorFallback() {
        let utterance = "I'm all out of credits. Please check your ElevenLabs account and add more credits to continue using ScreenGuide."
