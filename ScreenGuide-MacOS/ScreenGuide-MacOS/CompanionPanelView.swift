...
struct CompanionPanelView: View {
    ...
    private var permissionsCopySection: some View {
        if companionManager.hasCompletedOnboarding && companionManager.allPermissionsGranted {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Some permissions were revoked. Grant all four below to keep using ScreenGuide.")
                    .font(.system(size: 11))
                    .foregroundColor(DS.Colors.textTertiary)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Nothing runs in the background. ScreenGuide will only take a screenshot when you press the hot key. So, you can give that permission in peace. If you are still sus, eh, I can't do much there champ.")
                    .font(.system(size: 11))
    ...
    // MARK: - Show ScreenGuide Cursor Toggle

    private var showScreenGuideCursorToggleRow: some View {
        HStack {
            HStack(spacing: 8) {
            ...
            Toggle("", isOn: Binding(
                get: { companionManager.isScreenGuideCursorEnabled },
                set: { companionManager.setScreenGuideCursorEnabled($0) }
            ))
            .toggleStyle(.switch)
            .labelsHidden()
