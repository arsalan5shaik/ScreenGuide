; ────────────────────────────────────────────────────────────────────
;  ScreenGuide for Windows — Inno Setup script
;
;  Builds a single Setup-ScreenGuide.exe from the PyInstaller dist folder.
;
;  Prerequisites:
;    1. Run  build.bat  first (produces dist\ScreenGuide\)
;    2. Install Inno Setup 6 from https://jrsoftware.org/isdl.php
;    3. Run:  iscc installer.iss
;
;  Output:  dist\Setup-ScreenGuide.exe   (single-file installer, ~200-400 MB)
; ────────────────────────────────────────────────────────────────────

#define MyAppName        "ScreenGuide"
#define MyAppVersion     "1.2.0"
#define MyAppPublisher   "Arsalan and Pranav"
#define MyAppExeName     "ScreenGuide.exe"
...
OutputDir=dist
OutputBaseFilename=Setup-ScreenGuide
...
Name: "startupicon";  Description: "Launch ScreenGuide when Windows &starts";  GroupDescription: "Additional shortcuts:"; Flags: unchecked
...
Source: "dist\ScreenGuide\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
; Offer to launch ScreenGuide after install
...
begin
  ...
  begin
    MsgBox(
      'ScreenGuide installed successfully!' #13#13
      'On first launch, ScreenGuide will walk you through downloading the AI models' #13
