...
Action:   asks ScreenGuide's manager to actually click the next pointed element
          instead of just hovering on it.

Copy this file to ~/.screenguide/skills/ and edit, or write your own.
"""
...
SKILL = {
    ...
    "description": "Lets ScreenGuide click the element it points at.",
