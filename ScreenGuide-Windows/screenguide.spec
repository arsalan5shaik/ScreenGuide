...
"""
PyInstaller spec for ScreenGuide Windows.

Build:
    pyinstaller screenguide.spec --clean --noconfirm

Output:
    dist/ScreenGuide/ScreenGuide.exe           ← distribute this whole folder
...
a = Analysis(
    ...
    hooksconfig={},
    runtime_hooks=[],
    # Shave size: ScreenGuide never uses these heavy libs.
    excludes=[
